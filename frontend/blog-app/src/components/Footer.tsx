...
<footer className=" mt-20 border-gray-500 bg-gradient-to-b from-white via-red-50 to-indigo-50">
    <div className="container px-6 py-5 mx-auto">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            <div className="sm:col-span-2">
                <h1 className="max-w-lg text-xl font-semibold tracking-tight text-gray-800 xl:text-2xl">Subscribe to get leatest Blog update</h1>
        ...
        <div className="flex items-center justify-between">
            <a href="#">
                <img className="w-auto h-7" src="https://dhananjaya.tech/assets/Capture-xtWkUEyA.png" alt=""/>
            </a>
